...
function Card(props)
{
    ...
    return (
        <div className="flex font-serif bg-white rounded">
        <div className="flex-none w-52 relative">
          <img src="https://images.pexels.com/photos/15924953/pexels-photo-15924953/free-photo-of-a-bouquet-of-roses-in-a-glass-vase-on-a-windowsill.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
        </div>
